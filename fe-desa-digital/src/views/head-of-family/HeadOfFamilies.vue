...
const headOFamilyStore = useHeadOfFamilyStore()
const { headOfFamilies, meta, loading, error, success } = storeToRefs(headOFamilyStore)
const { fetchHeadOfFamiliesPaginated } = headOFamilyStore
...
<template>
    <div id="Header" class="flex items-center justify-between">
        ...
        <a href="kd-kepala-rumah-add.html"
    ...
    <section id="List-Kepala-Rumah" class="flex flex-col gap-[14px]">
        ...
        <CardList v-for="headOfFamily in headOfFamilies" 
          :key="headOfFamily.id" 
          :item="headOfFamily" 
          v-if="!loading" />
