...
<template>
    <div id="Header" class="flex items-center justify-between">
        ...
        <button data-modal="Modal-Delete" class="flex items-center rounded-2xl py-4 px-6 gap-[10px] bg-desa-red" @click="showModalDelete = true">
    ...
    <div class="flex gap-[14px]">
        <div class="flex flex-col w-[calc(525/1000*100%)] shrink-0 gap-[14px]">
            ...
            <section id="Anggota-Keluarga" class="flex flex-col rounded-3xl p-6 gap-6 bg-white" v-if="headOfFamily.family_members?.length">
                ...
                <div class="flex flex-col gap-[14px]">
                    <div class="card flex flex-col rounded-2xl border border-desa-background p-4 gap-6" v-for="familyMember in headOfFamily.family_members" :key="index">
                        <div class="flex items-center gap-4">
                            <div class="flex size-[64px] shrink-0 rounded-full overflow-hidden bg-desa-foreshadow">
                                <img :src="familyMember.profile_picture" class="w-full h-full object-cover"
                                    alt="photo">
                            </div>
                            <div class="flex flex-col gap-[6px] w-full">
    ...
    <div id="Modal-Delete" class="modal fixed inset-0 h-screen z-40 flex bg-[#080C1ACC]" :class="{ hidden: !showModalDelete }">
        <div id="Alert" class="flex flex-col w-[335px] shrink-0 rounded-2xl overflow-hidden bg-white m-auto">
            ...
            <div class="flex flex-col p-4 gap-3">
                ...
                <div class="flex items-center gap-3">
                    <button
                        class="btn-close-modal flex items-center h-14 rounded-2xl py-3 px-8 gap-[10px] border border-desa-background hover:bg-desa-black hover:text-white transition-setup" @click="showModalDelete = false">
