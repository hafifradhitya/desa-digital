...
<template>
    ...
    <div class="flex gap-[14px]">
            ...
            <div class="flex items-center w-full gap-3">
                ...
                <div class="flex flex-col gap-1 w-full">
                    <p class="font-semibold text-lg leading-[22.5px] text-desa-blue">
                        {{ socialAssistanceRecipient.social_assistance?.social_assistance_recipients?.length || 0 }} Warga
                    </p>
                    <span class="font-medium text-desa-secondary">
                        Total Pengajuan
                    </span>
        ...
        <section class="flex flex-col flex-1 h-fit shrink-0 rounded-3xl p-6 gap-6 bg-white">
            ...
            <div class="flex flex-col gap-6">
                ...
                <div class="flex items-center gap-3">
                    <div
                        ...
                        <img src="@/assets/images/logos/bca.svg" class="w-full h-full object-contain" alt="icon" v-if="socialAssistanceRecipient.bank === 'bca'">
                        <img src="@/assets/images/logos/bca.svg" class="w-full h-full object-contain" alt="icon" v-if="socialAssistanceRecipient.bank === 'bri'">
                        <img src="@/assets/images/logos/bca.svg" class="w-full h-full object-contain" alt="icon" v-if="socialAssistanceRecipient.bank === 'bni'">
                    </div>
                    <div>
            ...
            <hr class="border-desa-background">
            <form action="kd-pengajuan-bansos.html" class="flex flex-col gap-6">
