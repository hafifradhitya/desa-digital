    ...
    <form @submit.prevent="handleSubmit" id="myForm" class="capitalize">
        <div class="shrink-0 rounded-3xl p-6 bg-white flex flex-col gap-6 h-fit">
            ...
            <section id="Thumbnail" class="flex items-center justify-between">
                <h2 class="font-medium leading-5 text-desa-secondary w-[calc(424/904*100%)]">Thumbnail Pembangunan Terkait
                </h2>
                <div class="flex-1 flex items-center justify-between">
                    <div id="Photo-Preview"
                        class="flex itce justify-center w-[120px] h-[100px] rounded-2xl overflow-hidden bg-desa-foreshadow">
                        <img id="Photo" :src="development.thumbnail_url" alt="image"
            ...
            <section id="Nama-Projek" class="flex items-center justify-between">
                ...
                <div class="flex flex-col gap-3 flex-1 shrink-0">
                    <Input v-model="development.name" type="text" placeholder="Ketik Nama Kamu" 
            ...
            <section id="Penanggung-Jawab" class="flex items-center justify-between">
                ...
                <div class="flex flex-col gap-3 flex-1 shrink-0">
                    <Input v-model="development.person_in_charge" type="text" placeholder="Ketik Penanggung Jawab Pembangunan" 
                        :error-message="error?.person_in_charge" 
                        :icon="IconProfileCircleSecondaryGreen" :filled-icon="IconProfileCircleBlack" />
                </div>
            </section>
            <hr class="border-desa-background" />
            <section id="Penanggung-Jawab" class="flex items-center justify-between">
            ...
            <section id="Deskripsi" class="flex items-center justify-between">
                ...
                <div class="flex flex-col gap-3 flex-1 shrink-0">
                    <textarea v-model="development.description" name="" id="" placeholder="Jelaskan lebih detail tentang pembangunan" rows="6"
